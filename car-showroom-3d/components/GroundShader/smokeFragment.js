...
// codes
vec2 customFn_Y9Gj9OhwIaqd ( vec2 uv, float height, float scale, vec3 viewDir ) {
...
vec3 mod2D289_HeX3LnDXe04k ( vec3 x ) { return x - floor( x * ( 1.0 / 289.0 ) ) * 289.0; }

	vec2 mod2D289_HeX3LnDXe04k( vec2 x ) { return x - floor( x * ( 1.0 / 289.0 ) ) * 289.0; }

	vec3 permute_HeX3LnDXe04k( vec3 x ) { return mod2D289_HeX3LnDXe04k( ( ( x * 34.0 ) + 1.0 ) * x ); }

    float snoise_HeX3LnDXe04k( vec2 v ){
        ...
        x12.xy -= i1;
        i = mod2D289_HeX3LnDXe04k( i );
        vec3 p = permute_HeX3LnDXe04k( permute_HeX3LnDXe04k( i.y + vec3( 0.0, i1.y, 1.0 ) ) + i.x + vec3( 0.0, i1.x, 1.0 ) );
...
float customFn_Q1FctOumadxM ( vec2 uv, float scale ) {
                
    float noise = snoise_HeX3LnDXe04k( uv * scale );
...
nodeVar0 = customFn_Y9Gj9OhwIaqd( nodeVary0, 0.0, 0.0, vec3( 0, 0, 0 ) );
